...
app_description = "Manage Flights, Passengers, And Airports"
...
webform_include_js = {"airline": "public/js/airline_webform.js"}
...
scheduler_events = {
    "monthly": [
        "your_app.api.generate_rent_and_send_reminders"
    ]
}
...
patches = [
    "airplane_mode.patches.shop_types.execute"
]
